...
def pBrent(f, N=1, a=None, b=None, x0=None, rtol=_eps, atol=_eps, maxiter=5000):
    """ Seeks the minimums of a set of functions in parallel, each via Brent's method.

    Given a set of functions ``f``, each with a minimum in the interval ``a <= b``, for each one seeks a local
